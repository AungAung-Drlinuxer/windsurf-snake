...
class SnakeGame {
    constructor() {
        ...
        // Initialize graphics engine and then continue with initialization
        graphicsEngine.init('game-container').then(() => {
    ...
    showGameOver() {
        try {
            ...
            // Update the existing game over screen in the HTML
            document.getElementById('final-score').textContent = this.state.score;
            document.getElementById('final-high-score').textContent = this.state.highScore;
            ...
            document.getElementById('restart-button').onclick = () => this.resetGame();
            document.getElementById('submit-score').onclick = () => this.submitScore();
