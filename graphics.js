...
// Wait for the global objects to be available
function getGlobalObjects() {
    return new Promise((resolve) => {
        function check() {
            if (window.THREE) {
                THREE = window.THREE;
                OrbitControls = window.OrbitControls || window.THREE.OrbitControls;
                console.log('THREE.js objects found');
                resolve();
            } else {
                console.log('Waiting for THREE.js objects...');
...
export class GraphicsEngine {
    ...
    async init(containerId) {
        console.log('GraphicsEngine.init called');
        // Wait for global objects to be available
        await getGlobalObjects();
        console.log('Global objects acquired');
        ...
        console.log('GraphicsEngine.init completed');
    }
